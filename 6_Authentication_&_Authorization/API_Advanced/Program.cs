        ...
        public static async Task Main(string[] args)
        {
            ...
            using (var scope = host.Services.CreateScope())
            {
                ...
                try
                {
                    ...
                    await context.Database.MigrateAsync();//create db if it is not there
                    await BookContextSeed.SeedAsync(context, loggerFactory);
                    ...
                    await AppIdentityDbContextSeed.SeedUsersAsync(userManager, userRole);
                }
                catch (Exception ex)
                {
